  ...
  return (
    <form action={formAction} className="space-y-4 max-w-xl">
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-ink-soft mb-1">Amount</label>
        ...
        <div>
          <label className="block text-sm font-medium text-ink-soft mb-1">Trip (optional)</label>
          <EntityPicker entity="bookings" name="booking_id" placeholder="Search bookings…" />
        </div>
        <div>
          <label className="block text-sm font-medium text-ink-soft mb-1">Driver (optional)</label>
          <EntityPicker entity="drivers" name="driver_id" placeholder="Search drivers…" />
        </div>
        <div>
          <label className="block text-sm font-medium text-ink-soft mb-1">Vehicle (optional)</label>
