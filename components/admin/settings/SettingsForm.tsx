  ...
  return (
    <form action={formAction} className="space-y-8 max-w-3xl">
      <fieldset className="space-y-4">
        <legend className="text-sm font-semibold text-ink mb-2">Company</legend>
      ...
      <fieldset className="space-y-4">
        <legend className="text-sm font-semibold text-ink mb-2">Currency &amp; tax</legend>
        <div className="grid sm:grid-cols-2 gap-4">
      ...
      <fieldset className="space-y-4">
        <legend className="text-sm font-semibold text-ink mb-2">Document numbering</legend>
        <div className="grid sm:grid-cols-2 gap-4">
      ...
      <fieldset className="space-y-4">
        <legend className="text-sm font-semibold text-ink mb-2">Default document text</legend>
        <div>
