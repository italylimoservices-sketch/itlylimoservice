    ...
    <div>
          ...
          <tbody className="divide-y divide-line">
            {items.map((item, index) => (
              <tr key={index}>
                ...
                <td className="px-3 py-1.5 text-ink">{formatCurrency(item.quantity * item.unit_price, currency)}</td>
      ...
      <div className="mt-4 ml-auto max-w-xs space-y-2 text-sm">
        ...
        <div className="flex items-center justify-between gap-3">
          <label htmlFor="discount" className="text-stone">
            Discount
          </label>
          <input
            id="discount"
        ...
        <div className="flex items-center justify-between gap-3">
          <label htmlFor="tax_rate" className="text-stone">
            Tax rate (%)
          </label>
          <input
            id="tax_rate"
        ...
        <div className="flex items-center justify-between font-semibold text-ink text-base pt-2 border-t border-line">
          <span>Total</span>
