...
export function InviteUserForm() {
  ...
  return (
    <form action={formAction} className="p-4 space-y-3">
      ...
      <div>
        <label className="block text-xs text-stone mb-1">Role</label>
      ...
      <p className="text-xs text-stone">Sends a Supabase Auth email invite so they can set their own password.</p>
    </form>
  );
}
