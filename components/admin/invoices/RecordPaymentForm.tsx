...
export function RecordPaymentForm({
  ...
  return (
    <form action={formAction} className="p-4 space-y-3">
      <div>
        <label className="block text-xs text-stone mb-1">Amount ({currency})</label>
        ...
        <p className="text-xs text-stone mt-1">Balance due: {balanceDue.toFixed(2)} {currency}</p>
      </div>
      <div>
        <label className="block text-xs text-stone mb-1">Method</label>
      ...
      <div>
        <label className="block text-xs text-stone mb-1">Reference number</label>
        <input name="reference_number" className="input-luxe" />
      </div>
      <div>
        <label className="block text-xs text-stone mb-1">Payment date</label>
      ...
      <button
        ...
        className="w-full bg-navy text-ivory text-sm font-semibold px-3 py-2 rounded-sm hover:bg-navy-deep disabled:opacity-50"
      >
