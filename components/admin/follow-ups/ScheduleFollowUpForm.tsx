...
export function ScheduleFollowUpForm() {
  ...
  return (
    <form action={formAction} className="p-4 space-y-3">
      ...
      <div>
        <label className="block text-xs text-stone mb-1">Due date</label>
      ...
      <button type="submit" disabled={pending} className="w-full text-sm bg-navy text-ivory px-3 py-2 rounded-sm hover:bg-navy-deep disabled:opacity-60">
