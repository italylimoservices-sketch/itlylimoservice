  ...
  return (
    <form action={formAction} className="space-y-4 max-w-2xl">
      <div className="grid sm:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-ink-soft mb-1">Customer type</label>
      ...
      {customerType === "COMPANY" ? (
        <fieldset className="border border-line rounded-sm p-4 space-y-4">
          <legend className="text-sm font-medium text-ink-soft px-1">Corporate billing</legend>
          <div className="grid sm:grid-cols-2 gap-4">
