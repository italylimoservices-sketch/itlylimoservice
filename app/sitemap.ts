...
const staticPaths = [
  ...
  { path: "/our-guarantee", priority: 0.5, changeFrequency: "yearly" as const },
  { path: "/airport-meeting-instructions", priority: 0.5, changeFrequency: "monthly" as const },
  { path: "/cruise-arrival-instructions", priority: 0.5, changeFrequency: "monthly" as const },
