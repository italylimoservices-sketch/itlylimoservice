    ...
    <div>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 text-sm border border-line px-3 py-2 rounded-sm hover:bg-white ml-auto"
        >
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-line">
                {result.rows.map((row, i) => (
                  <tr key={i} className="hover:bg-ivory-deep">
                    {row.map((cell, j) => (
