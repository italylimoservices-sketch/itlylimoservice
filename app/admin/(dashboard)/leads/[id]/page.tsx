          ...
          {canEdit ? (
            <Section title="Pipeline">
              <div className="p-4 space-y-3">
                    ...
                    <form key={s} action={setLeadStatus.bind(null, id, s)}>
                      <button
                        ...
                        className={`text-xs px-2.5 py-1.5 rounded-sm border ${
                          lead.status === s ? "border-navy bg-navy text-ivory" : "border-line hover:bg-ivory-deep"
                        }`}
                      >
                        {s}
                      </button>
                ...
                <form action={assignLead.bind(null, id)} className="flex gap-2 pt-2 border-t border-line">
                  ...
                  <button type="submit" className="border border-line px-3 py-2 rounded-sm text-sm hover:bg-ivory-deep">
                    Assign
                  </button>
                </form>
              </div>
          ...
          {canEdit ? (
            <Section title="Convert">
              <div className="p-4 space-y-2">
                {lead.customer_id ? (
                  <Link href={`/admin/customers/${lead.customer_id}`} className="block text-sm text-gold hover:underline">
