        ...
        <Section title="Fleet & driver utilization">
          <div className="p-4 space-y-3 text-sm">
            <div className="flex justify-between">
              <span className="text-stone">Fleet size</span>
              <span>{vehiclesCount ?? 0}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-stone">Active drivers</span>
              <span>{driversCount ?? 0}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-stone">Fleet utilization (had a trip)</span>
              <span>{fleetUtilization.toFixed(0)}%</span>
            </div>
            <div className="flex justify-between">
              <span className="text-stone">Driver utilization</span>
