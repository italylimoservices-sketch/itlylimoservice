              ...
              <li key={p.id} className="px-4 py-3">
                <div className="flex items-start justify-between gap-3 mb-2">
                  <div>
                    ...
                    {p.reconciliation_notes ? <p className="text-xs text-stone mt-1">{p.reconciliation_notes}</p> : null}
                  </div>
                ...
                <form action={reconcilePayment.bind(null, p.id)} className="flex flex-wrap items-center gap-2">
                  ...
                  <button type="submit" className="text-xs bg-navy text-ivory px-3 py-1 rounded-sm hover:bg-navy-deep">
                    Save
                  </button>
                </form>
              </li>
