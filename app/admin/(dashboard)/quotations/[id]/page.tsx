        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              target="_blank"
              className="inline-flex items-center gap-1.5 text-sm border border-line px-3 py-2 rounded-sm hover:bg-white"
            >
          ...
          <Section title="Quotation">
            <div className="p-4">
              {canEdit ? (
                ...
                <p className="text-sm text-stone">You don&apos;t have permission to edit quotations.</p>
              )}
            </div>
          </Section>
        </div>
            ...
            <Section title="Actions">
              <div className="p-4 space-y-2">
                ...
                {quotation.status !== "CONVERTED" ? (
                  ...
                  <p className="text-xs text-stone">Already converted to a booking.</p>
                )}
              </div>
            </Section>
          </div>
