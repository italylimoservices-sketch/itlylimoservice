      ...
      <div className="space-y-4">
        <Section title="Rate cards (per vehicle category + currency)">
          <div className="p-4 space-y-4">
            ...
            />
            <form action={createRateCard} className="grid sm:grid-cols-6 gap-2 items-end border-t border-line pt-4">
        ...
        <Section title="Fixed-price routes">
          <div className="p-4 space-y-4">
            ...
            <form action={createRouteRate} className="grid sm:grid-cols-6 gap-2 items-end border-t border-line pt-4">
        ...
        <Section title="Surcharges">
          <div className="p-4 space-y-4">
            ...
            />
            <form action={createSurchargeRule} className="grid sm:grid-cols-6 gap-2 items-end border-t border-line pt-4">
              ...
              <div>
                <label className="block text-xs text-stone mb-1">Starts (night only)</label>
                <input type="time" name="starts_at" className="input-luxe" />
              </div>
              <div>
                <label className="block text-xs text-stone mb-1">Ends (night only)</label>
        ...
        <Section title="Holiday dates">
          <div className="p-4 space-y-4">
            ...
            />
            <form action={createHolidayDate} className="grid sm:grid-cols-4 gap-2 items-end border-t border-line pt-4">
              <div>
...
function SubmitButton({ children }: { children: React.ReactNode }) {
  return <button type="submit" className="text-sm bg-navy text-ivory px-4 py-2 rounded-sm hover:bg-navy-deep">{children}</button>;
}
