      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap items-center gap-2">
            <Link href={`/admin/drivers/${id}`} className="inline-flex items-center gap-1.5 border border-line px-3 py-2 rounded-sm text-sm hover:bg-white">
            ...
            <Link href={`${base}?view=${view}&date=${nav.prev}`} className="border border-line px-3 py-2 rounded-sm text-sm hover:bg-white">
              ← Prev
            </Link>
            <Link href={`${base}?view=${view}&date=${format(new Date(), "yyyy-MM-dd")}`} className="border border-line px-3 py-2 rounded-sm text-sm hover:bg-white">
              Today
            </Link>
            <Link href={`${base}?view=${view}&date=${nav.next}`} className="border border-line px-3 py-2 rounded-sm text-sm hover:bg-white">
              Next →
            </Link>
          </div>
        }
