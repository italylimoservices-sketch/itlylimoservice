              ...
              <li key={a.id} className="px-4 py-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {a.message ? <p className="text-xs text-stone mt-0.5">{a.message}</p> : null}
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      <form action={setAlertStatus.bind(null, a.id, "ACKNOWLEDGED")}>
                        <button type="submit" className="text-xs border border-line px-2 py-1 rounded-sm hover:bg-ivory-deep" disabled={a.status === "ACKNOWLEDGED"}>
                          Acknowledge
                        </button>
                      </form>
                      ...
                      <form action={assignAlert.bind(null, a.id)} className="flex items-center gap-1 w-56">
                        ...
                        <button type="submit" className="text-xs border border-line px-2 py-1 rounded-sm hover:bg-ivory-deep shrink-0">
                          Go
                        </button>
                      </form>
                    </div>
